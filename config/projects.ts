...
export const projects: Project[] = [
  {
    ...
    website: 'https://github.com/prathmesh796/getLancer',
    description:
      'getLance is a freelancing platform, specially targeting those people who are just try to enter the freelancing world most of these include those students who are looking for some goto experience.',
    shortDescription: 'Ready to deploy, freelancing platform.',
    repository: 'https://github.com/prathmesh796/getLancer',
    stack: [
      Stack.javascript,
      Stack.react,
      Stack.node,
    ...
    deployment: {
      web: 'https://github.com/prathmesh796/getLancer',
    },
    subProjects: [],
  },
  {
